...
if [ -f ./github/workspace/contact.json ] && [ -f ./github/workspace/main_data.json ]
then
    echo "all files are present"
    #copy the files over into ./src/data
    echo "copying the files over into ./src/data"
    cp ./github/workspace/contact.json ./src/data/contact.json
    cp ./github/workspace/main_data.json ./src/data/main_data.json
else
